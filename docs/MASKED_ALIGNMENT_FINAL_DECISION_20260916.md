...
| --- | --- | --- | ---: | ---: |
| 並進(realrange, Δx≈−26.8px) | ECC | なし | 33.88% | 99.94% |
| 並進(realrange) | ECC | **あり** | **26.16%** | 99.94% |
| 並進(realrange) | ORB | なし | 100.00% | 78.49% |
| 並進(realrange) | ORB | あり | 100.00% | 78.61% |
| 縦(ty, Δy≈+20.2px) | ECC | なし/あり | 100.00% | 65.05% (両方) |
| 縦(ty) | ORB | なし/あり | 100.00% | 63.9〜64.1%(両方) |
| 回転(theta, Δθ≈−0.198度) | ECC | なし/あり | 100.00% | 0.00%(両方) |
| 回転(theta) | ORB | なし | 94.19% | **98.91%** |
| 回転(theta) | ORB | **あり** | **100.00%** | **0.00%** |
| 拡大縮小(scale, Δs≈−0.47pp) | ECC | なし | 100.00% | 0.00% |
| 拡大縮小(scale) | ECC | あり | 100.00% | 37.60%(悪化) |
| 拡大縮小(scale) | ORB | なし | 100.00% | 39.19% |
| 拡大縮小(scale) | ORB | **あり** | **100.00%** | **0.00%** |
