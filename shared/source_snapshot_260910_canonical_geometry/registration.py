...
def sample_contrast(img, coords):
    """Normalized 3x3 SUM minus 3x3 SUM of Gaussian(51x51) background."""
    ...
    return pd.DataFrame(dict(ints=ints, bg_ints=bg_ints, contrast=ints-bg_ints, valid_sampling=valid))
